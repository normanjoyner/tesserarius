...
module.exports = {
    ...
    create_chain(chain, callback) {
        ...
        const args = [constants.FLAGS.NEW_CHAIN, chain];
        execute_command(args, callback);
    },

    flush(chain, callback) {
        const args = [ constants.FLAGS.FLUSH ];
    ...
    policy(chain, policy, callback) {
        ...
        const args = [constants.FLAGS.POLICY, chain, policy];
        execute_command(args, callback);
    }
